% !TeX root = on-abelian-varieties.tex
...
\subsection{Product of elliptic curves}
    ...
    Hence, we have the conclusion in \cref{table:intersection_of_invariant_subspaces_with_psef_cone_on_product_of_elliptic_curves:abelian-varieties}.
    \begin{table}[!ht]
        \centering
        ...
        \label{table:intersection_of_invariant_subspaces_with_psef_cone_on_product_of_elliptic_curves:abelian-varieties}
    \end{table}
    ...
    \begin{example}\label{eg:Jordan_block_acts_on_NS_by_endomorphism_of_product_of_elliptic_curves:abelian-varieties}
    ...
    % \begin{figure}[!ht]
    %     \centering
    %     \includegraphics[width=0.3\textwidth]{jordan-block-action-plot-product-of-elliptic-curve.png}
    ...
    %     \lstinputlisting[language=Python, caption={Test invariant subspaces of \(\NS(E\times E)\)}, label=code:matrix_representation_of_dynamics_on_product_of_elliptic_curves]{matrix-representation-of-dynamics-on-e-times-e.sage}
